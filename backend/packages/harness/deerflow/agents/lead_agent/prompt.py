...
Example Agent Framework is an open-source agent project
[citation:Source Repository](https://example.com/example-agent/repository). The project focuses on
sandbox execution and memory management
[citation:Project Documentation](https://example.com/example-agent/docs).
...
### Primary Sources
- [Source Repository](https://example.com/example-agent/repository) - Public source code
- [Project Documentation](https://example.com/example-agent/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[Source Repository](https://example.com/example-agent/repository) - 公开源代码`
