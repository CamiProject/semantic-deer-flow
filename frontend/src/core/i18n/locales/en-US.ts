...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to the Semantic DeerFlow development workspace. This debugging UI exercises the governed SaaS semantic and Action APIs while retaining the upstream agent harness and extensible Skills.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Semantic DeerFlow. With customized skills,\nSemantic DeerFlow can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Semantic DeerFlow is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Semantic DeerFlow could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "Semantic DeerFlow project website",
    githubTooltip: "Semantic DeerFlow on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "Semantic DeerFlow on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About Semantic DeerFlow",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your Semantic DeerFlow bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your Semantic DeerFlow bot.",
      feishu: "Feishu and Lark messages through your Semantic DeerFlow app.",
      dingtalk:
        "DingTalk Stream Push messages through your Semantic DeerFlow bot.",
      wechat: "WeChat iLink messages through your Semantic DeerFlow bot.",
      wecom: "WeCom messages through your Semantic DeerFlow AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip:
      "Install skill and make it available to Semantic DeerFlow",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Semantic DeerFlow faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Semantic DeerFlow looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Semantic DeerFlow automatically learns from your conversations in the background. These memories help Semantic DeerFlow understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to Semantic DeerFlow from outside the browser.",
      disabled:
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Semantic DeerFlow.",
    ...
    notification: {
      title: "Notification",
      description:
        "Semantic DeerFlow only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "Semantic DeerFlow",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so Semantic DeerFlow cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "Semantic DeerFlow needs an administrator account before new regular accounts can be created.",
