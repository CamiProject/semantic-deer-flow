...
export const zhCN: Translations = {
  ...
  // Welcome
  welcome: {
    greeting: "欢迎回到Semantic DeerFlow 开发工作台！",
    description:
      "欢迎使用 Semantic DeerFlow 开发工作台。该调试界面用于验证受治理的 SaaS 语义查询与 Action API，并保留上游 Agent Harness 和可扩展 Skills。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Semantic DeerFlow 的潜力。通过自定义技能，Semantic DeerFlow\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    suggestions: [
      ...
      },
      {
        suggestion: "分析设备报表",
        prompt:
          "用 SQL 技能查询公开演示租户中示例场地的本月项目数量逐日统计，并用 chart 技能生成英文折线图。",
        icon: BarChartIcon,
      },
    ],
    suggestionsCreate: [
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，Semantic DeerFlow 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 Semantic DeerFlow 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 Semantic DeerFlow 项目网站",
    githubTooltip: "访问 Semantic DeerFlow 的 GitHub 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 GitHub 上查看 Semantic DeerFlow",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 Semantic DeerFlow",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 Semantic DeerFlow Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 Semantic DeerFlow Bot 接收 Discord 服务器消息。",
      feishu: "通过 Semantic DeerFlow 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 Semantic DeerFlow Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 Semantic DeerFlow Bot 接收微信 iLink 消息。",
      wecom: "通过 Semantic DeerFlow AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Semantic DeerFlow 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "使用键盘快捷键更快地操作 Semantic DeerFlow。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Semantic DeerFlow 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "Semantic DeerFlow 会在后台不断从你的对话中自动学习。这些记忆能帮助 Semantic DeerFlow 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    channels: {
      title: "渠道",
      description:
        "连接可在浏览器外向 Semantic DeerFlow 发送消息的即时通讯账号。",
      disabled:
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Semantic DeerFlow 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "Semantic DeerFlow 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，Semantic DeerFlow 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "Semantic DeerFlow 需要先创建管理员账号，然后才能创建新的普通账号。",
